...
publish: prepublish
    ...
    #
	#./node_modules/.bin/lerna publish --force-publish="@gerhobbelt/babel-runtime,@gerhobbelt/babel-runtime-corejs2" --dangerously-only-publish-explicit-updates-this-is-a-custom-flag-for-babel-and-you-should-not-be-using-it-just-deal-with-more-packages-being-published-it-is-not-a-big-deal
	#
