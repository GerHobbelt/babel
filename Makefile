...
prepublish-build:
	...
	NODE_ENV=production BABEL_ENV=production make build-no-bundle build-dist
	make clone-license
...
new-version:
	#git pull --rebase
	./node_modules/.bin/lerna version --force-publish="@gerhobbelt/babel-runtime,@gerhobbelt/babel-runtime-corejs2,@gerhobbelt/babel-runtime-corejs3,@gerhobbelt/babel-standalone,@gerhobbelt/babel-preset-env-standalone"
