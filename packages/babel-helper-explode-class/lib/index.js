...
function _babelHelperBindifyDecorators() {
  const data = _interopRequireDefault(require("@gerhobbelt/babel-helper-bindify-decorators"));

  _babelHelperBindifyDecorators = function () {
    return data;
  };
...
function _default(classPath) {
  ...
  function memoiseDecorators(paths) {
    ...
    paths = paths.reverse();
    (0, _babelHelperBindifyDecorators().default)(paths);
