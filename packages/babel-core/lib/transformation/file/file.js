...
function helpers() {
  const data = _interopRequireWildcard(require("@gerhobbelt/babel-helpers"));
...
function _babelTraverse() {
  const data = _interopRequireWildcard(require("@gerhobbelt/babel-traverse"));
...
class File {
  ...
  addImport() {
    throw new Error("This API has been removed. If you're looking for this " + "functionality in Babel 7, you should import the " + "'@gerhobbelt/babel-helper-module-imports' module and use the functions exposed " + " from that module, such as 'addNamed' or 'addDefault'.");
  }
