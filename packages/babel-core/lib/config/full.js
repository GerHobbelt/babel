...
const loadDescriptor = (0, _caching.makeWeakCache)(({
  ...
  if (typeof item.then === "function") {
    throw new Error(`You appear to be using an async plugin, ` + `which your current version of Babel does not support.` + `If you're using a published plugin, ` + `you may need to upgrade your @gerhobbelt/babel-core version.`);
  }
...
const instantiatePlugin = (0, _caching.makeWeakCache)(({
  ...
  if (plugin.visitor) {
    plugin.visitor = _babelTraverse().default.explode(Object.assign({}, plugin.visitor));
  }
