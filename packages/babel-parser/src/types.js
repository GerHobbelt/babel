...
//   in @gerhobbelt/babel-parser these cause exceptions, so the AST format is stricter.
...
// But for @gerhobbelt/babel-parser, `export default` is an ExportDefaultDeclaration,
