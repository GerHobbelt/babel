...
var _default = (0, _babelHelperPluginUtils().declare)((api, opts) => {
  ...
  if (optionsTargets && optionsTargets.uglify) {
    throw new Error("The uglify target has been removed. Set the top level" + " option `forceAllTransforms: true` instead.");
  }

  if (optionsTargets && optionsTargets.esmodules && optionsTargets.browsers) {
    console.log("");
    console.log("@gerhobbelt/babel-preset-env: esmodules and browsers targets have been specified together.");
