...
const buildAnonymousExpressionWrapper = _babelTemplate().default.expression(`
  (function () {
    var REF = FUNCTION;
...
const buildNamedExpressionWrapper = _babelTemplate().default.expression(`
  (function () {
    var REF = FUNCTION;
...
const buildDeclarationWrapper = (0, _babelTemplate().default)(`
