...
function arrowFunctionToExpression({
  ...
  if (specCompliant) {
    ...
    this.replaceWith(t().callExpression(t().memberExpression((0, _babelHelperFunctionName().default)(this, true) || this.node, t().identifier("bind")), [checkBinding ? t().identifier(checkBinding.name) : t().thisExpression()]));
  }
}
