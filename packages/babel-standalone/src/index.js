...
// Wait! Please read https://github.com/babel/babel/pull/6177 first.
registerPresets({
  es2015: require("@gerhobbelt/babel-preset-es2015"),
  es2016: require("@gerhobbelt/babel-preset-es2016"),
  es2017: require("@gerhobbelt/babel-preset-es2017"),
  react: require("@gerhobbelt/babel-preset-react"),
  "stage-0": require("@gerhobbelt/babel-preset-stage-0"),
  "stage-1": require("@gerhobbelt/babel-preset-stage-1"),
  "stage-2": require("@gerhobbelt/babel-preset-stage-2"),
  "stage-3": require("@gerhobbelt/babel-preset-stage-3"),
  "es2015-loose": {
    presets: [[require("@gerhobbelt/babel-preset-es2015"), { loose: true }]],
  },
  // ES2015 preset with es2015-modules-commonjs removed
  "es2015-no-commonjs": {
    presets: [[require("@gerhobbelt/babel-preset-es2015"), { modules: false }]],
  },
