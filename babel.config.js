  ...
  const config = {
    ...
    overrides: [
      ...
      },
      {
        ...
        presets: [["@gerhobbelt/babel-env", envOptsNoTargets]],
        plugins: [["@gerhobbelt/babel-transform-modules-commonjs", { lazy: false }]],
      },
      {
      ...
      },
      {
        ...
        plugins: [
          includeRuntime
            ? ["@gerhobbelt/babel-transform-runtime", { version: "7.4.4" }]
            : null,
        ].filter(Boolean),
      },
    ].filter(Boolean),
